...
class MessageRepositoryTest {
    ...
    void deleteAllByChannelId_DeletesAllMessages() {
        ...
        List<Message> channelMessages = messageRepository.findAllByChannelIdOrderByCreatedAtDesc(
                channel.getId(),
        ...
        List<Message> otherChannelMessages = messageRepository.findAllByChannelIdOrderByCreatedAtDesc(
                otherChannel.getId(),
                Instant.now().plus(1, ChronoUnit.DAYS),
                PageRequest.of(0, 100)
        ).getContent();
